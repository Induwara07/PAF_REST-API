...
public class hospitalService {
	...
	public String insertHospital(@FormParam("hpCode") String hpCode, @FormParam("hpName") String hpName,
			@FormParam("hpTp") String hpTp, @FormParam("hpAddress") String hpAddress, @FormParam("hpDoctors") String hpDoctors, @FormParam("hpDesc") String hpDesc) {
		String output = hospitalObj.insertHospital(hpCode, hpName, hpTp, hpAddress,hpDoctors,hpDesc);
		return output;
	}
	...
	public String updateHospital(String hospitalData) {
		...
		String hpID = hospitalObject.get("hID").getAsString();
